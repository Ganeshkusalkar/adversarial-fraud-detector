...
class FraudSHAPExplainer:
    def __init__(self, predictor: CalibratedFraudPredictor, background_data: np.ndarray = None):
        """
        ...
        if background_data is None:
            ...
            logger.warning("No background data provided for SHAP. Using synthetic zero-baseline.")
