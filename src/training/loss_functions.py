...
"""
from src.training.losses import FocalLoss, ClassWeightedCrossEntropy, AdversarialGeneratorLoss

# Backward-compatible alias
AdversarialLoss = AdversarialGeneratorLoss

__all__ = ["FocalLoss", "ClassWeightedCrossEntropy", "AdversarialLoss", "AdversarialGeneratorLoss"]
